...
public class FinancialReportService {
  ...
  public FinancialReportDTO getFinancialReport(
      GroupBy groupBy, LocalDate from, LocalDate to, Integer year, Integer month) {
    ...
    List<FinancialReportRowDto> rowDtos =
        rows.stream()
            .map(
                row -> {
    ...
    BigDecimal initialBalance =
        Optional.ofNullable(transactionRepository.getNetBalance(instantFrom))
